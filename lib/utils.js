...
(function() {
  var DEFAULT_COLLECTION, DEFAULT_POOL_SIZE, MongoClient, _, _buildOptions, driverCompatShim, urlBuilder, validateConnSettings,
    slice = [].slice;
  ...
  driverCompatShim = function(cb) {
    return function(err, client) {
      ...
      db.close = function() {
        ...
        return client.close.apply(client, args);
      };
      return cb(err, db);
    };
  };
  ...
  exports.connect = function(config, cb) {
    ...
    return MongoClient.connect(url, options, driverCompatShim(cb));
  };
